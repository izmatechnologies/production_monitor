...
class WipNetworkModule {

    @Qualifier
    @Retention(AnnotationRetention.BINARY)
    annotation class  WipClient
    ...
    @Singleton
    @RetrofitWip
    fun provideRetrofitInstance(@WipClient defaultHttpClient: OkHttpClient): Retrofit =
        Retrofit.Builder()
    ...
    @Provides
    @Singleton
    fun provideRestApis(@RetrofitWip retrofit: Retrofit): WipApiService =
        retrofit.create(WipApiService::class.java)



    @Qualifier
    @Retention(AnnotationRetention.BINARY)
    annotation class RetrofitWip
