...
class PcbNetWorkModule {

    @Qualifier
    @Retention(AnnotationRetention.BINARY)
    annotation class PcbClient
    ...
    @Singleton
    @RetrofitPcb
    fun provideRetrofitInstance(@PcbClient defaultHttpClient: OkHttpClient): Retrofit =
        Retrofit.Builder()
    ...
    @Provides
    @Singleton
    fun provideRestApis(@RetrofitPcb retrofit: Retrofit): PcbApiService =
        retrofit.create(PcbApiService::class.java)



    @Qualifier
    @Retention(AnnotationRetention.BINARY)
    annotation class RetrofitPcb
